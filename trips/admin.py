...
class TripAdmin(admin.ModelAdmin):
    list_display  = ('destination', 'user', 'days', 'budget', 'budget_type', 'num_people',
                     'travel_type', 'travel_mode', 'origin', 'created_at')
...
class ReviewAdmin(admin.ModelAdmin):
    ...
    def star_display(self, obj):
        ...
        color = "#D4762A" if obj.overall_rating >= 4 else ("#E57373" if obj.overall_rating <= 2 else "#F9A825")
